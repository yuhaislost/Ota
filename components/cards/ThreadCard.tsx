                ...
                <div className="flex w-full flex-1 flex-row gap-4">
                    <div className="flex flex-col items-center">
                        <Link href={`profile/${author.id}`} className="relative h-11 w-11 ">
                            <Image src={author.profileImage} alt='Profile_image' fill className="cursor-pointer rounded-full"/>
                        </Link>
                        <div className="thread-card_bar"/>
                    </div>
                    <div className="flex w-full flex-col">
                        <Link href={`profile/${author.id}`} className="w-fit">
                            <h4 className="curosr-pointer text-base-semibold text-light-1">{author.username}</h4>
                        </Link>
                        ...
                        <div className="mt-5 flex flex-col gap-3">
                            <div className="flex gap-3.5">
                                ...
                                <Image src={'/assets/share.svg'} alt={"repost"} width={24} height={24} className="cursor-pointer object-contain"/>
                                <Image src={'/assets/repost.svg'} alt={"share"} width={24} height={24} className="cursor-pointer object-contain"/>
                            </div>
